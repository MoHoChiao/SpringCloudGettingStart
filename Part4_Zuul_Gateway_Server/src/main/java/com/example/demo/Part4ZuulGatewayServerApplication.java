 ...
 */
@EnableEurekaClient
public class Part4ZuulGatewayServerApplication {

	@Bean
	public PreRequestLogFilter preRequestLogFilter() { //宣告一個Zuul Filter的Bean
		return new PreRequestLogFilter();
	}
	
	public static void main(String[] args) {
		SpringApplication.run(Part4ZuulGatewayServerApplication.class, args);
	}
}
